...
/**
 * Job: ligne Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ligne implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ligne";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ligne.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_MSPR2_ligne = new byte[0];
    static byte[] commonByteArray_MSPR2_ligne = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR2_ligne.length) {
				if(length < 1024 && commonByteArray_MSPR2_ligne.length == 0) {
   					commonByteArray_MSPR2_ligne = new byte[1024];
				} else {
   					commonByteArray_MSPR2_ligne = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR2_ligne, 0, length);
			strReturn = new String(commonByteArray_MSPR2_ligne, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR2_ligne) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.type_service = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.nom_ligne,dos);
					...
					// String
						...
						writeString(this.type_service,dos);
    ...
    public String toString() {
		...
		sb.append(",nom_ligne="+nom_ligne);
		sb.append(",distance="+String.valueOf(distance));
		sb.append(",type_service="+type_service);
	    sb.append("]");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		synchronized(commonByteArrayLock_MSPR2_ligne) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.route_short_name = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.route_short_name,dos);
    ...
    public String toString() {
		...
		sb.append(",route_short_name="+route_short_name);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ligne");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ligne");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YbA6Bmp2Nm8mA7A4MHI6stQrNMP9sh6IHnLozv7tcFkrx7Sp9MIqTRU=");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"id_ligne\",\"nom_ligne\",\"distance\",\"type_service\") VALUES (?,?,?,?)";
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
		...
		int tos_count_tFileInputRaw_1 = 0;
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File("C:/Users/josep/Mspr2/MSPR/données/nigth/routes.json"), "ISO-8859-15");
					row1.content = content_tFileInputRaw_1;					
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", "C:/Users/josep/Mspr2/MSPR/données/nigth/routes.json");
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.route_short_name";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.route_short_name = value_tExtractJSONFields_1 == null ? 

		null

 : value_tExtractJSONFields_1.toString();
		} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_1) {
			row2.route_short_name = 
...
;
		...
		try {
				...
				row2.distance = value_tExtractJSONFields_1 == null ? 
...
;
		...
		try {
				...
				row2.classes = value_tExtractJSONFields_1 == null ? 
...
out1_tmp.nom_ligne = row2.route_short_name ;
out1_tmp.distance = (row2.distance==null||row2.distance.isEmpty()) ? null : Double.parseDouble(row2.distance);
out1_tmp.type_service = (row2.classes!=null&&(row2.classes.contains("sleeper")||row2.classes.contains("couchette"))) ? "NUIT" : "JOUR";
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((out1.id_ligne == null? false : out1.id_ligne.compareTo(ParserUtils.parseTo_Integer(String.valueOf(0))) > 0)
                           , "id_ligne.compareTo(0) > 0 failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row3 == null){ 
               ...
               row3.id_ligne = out1.id_ligne;
               row3.nom_ligne = out1.nom_ligne;
               row3.distance = out1.distance;
               row3.type_service = out1.type_service;    
...
if(row3 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row3.id_ligne == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, row3.id_ligne);
}

                    if(row3.nom_ligne == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row3.nom_ligne);
}

                    if(row3.distance == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(3, row3.distance);
}

                    if(row3.type_service == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row3.type_service);
}
 ...
 */
    ...
    public static void main(String[] args){
        final ligne ligneClass = new ligne();

        int exitCode = ligneClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ligne.class.getClassLoader().getResourceAsStream("mspr2/ligne_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ligne.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ligne");
        }
...
/************************************************************************************************
 *     68274 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:23:40 CEST
 ************************************************************************************************/