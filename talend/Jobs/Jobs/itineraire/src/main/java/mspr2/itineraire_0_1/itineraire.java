...
/**
 * Job: itineraire Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class itineraire implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "itineraire";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(itineraire.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_MSPR2_itineraire = new byte[0];
    static byte[] commonByteArray_MSPR2_itineraire = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.code_uic == null) ? 0 : this.code_uic.hashCode());
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR2_itineraire.length) {
				if(length < 1024 && commonByteArray_MSPR2_itineraire.length == 0) {
   					commonByteArray_MSPR2_itineraire = new byte[1024];
				} else {
   					commonByteArray_MSPR2_itineraire = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR2_itineraire, 0, length);
			strReturn = new String(commonByteArray_MSPR2_itineraire, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR2_itineraire) {
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
		...
		synchronized(commonByteArrayLock_MSPR2_itineraire) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.stop_sequence = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.stop_sequence,dos);
    ...
    public String toString() {
		...
		sb.append(",stop_sequence="+stop_sequence);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("itineraire");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("itineraire");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cwIlLogREYfqKP6jlSGGAt0IgfBnH2G4+VjH3y9idhHB4nbWC9pTVyg=");
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"trajet_id\" = ? AND \"code_uic\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"trajet_id\",\"chemin\",\"code_uic\") VALUES (?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"chemin\" = ? WHERE \"trajet_id\" = ? AND \"code_uic\" = ?";
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"trip_id","stop_sequence","stop_id",});        
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
		...
		int tos_count_tFileInputRaw_1 = 0;
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File("C:/Users/josep/Mspr2/MSPR/données/nigth/trip_stop.json"), "UTF-8");
					row1.content = content_tFileInputRaw_1;					
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", "C:/Users/josep/Mspr2/MSPR/données/nigth/trip_stop.json");
...
;
		...
		try {
				...
				row2.stop_sequence = value_tExtractJSONFields_1 == null ? 
...
///////////////////////		
	    		...
	    		if(row2.stop_sequence != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row2.stop_sequence)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.stop_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row2.stop_id)			
					          ;	
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.gare = '" + row4HashKey.gare + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row7HashKey.trip_id = row2.trip_id ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.trip_id = '" + row7HashKey.trip_id + "'");
								} // G 071
...
// # Output table : 'out1'
out1_tmp.trajet_id = row2.trip_id ;
out1_tmp.chemin = row7.via ;
out1_tmp.code_uic = row4.uic ;
out1 = out1_tmp;
...
if(out1 != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((out1.code_uic == null? false : out1.code_uic.compareTo("") != 0)
                           , "code_uic.compareTo(\"\") != 0 failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row5 == null){ 
                row5 = new row5Struct();
              }
               row5.trajet_id = out1.trajet_id;
               row5.chemin = out1.chemin;
               row5.code_uic = out1.code_uic;    
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row5.trajet_id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row5.trajet_id);
}

                    if(row5.code_uic == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row5.code_uic);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row5.chemin);
}

                        if(row5.trajet_id == null) {
pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row5.trajet_id);
}

                        if(row5.code_uic == null) {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row5.code_uic);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row5.trajet_id);
}

                        if(row5.chemin == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row5.chemin);
}

                        if(row5.code_uic == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, row5.code_uic);
}
 ...
 */
	...
	String from_tSendMail_2 = ("send@example.com");
    String to_tSendMail_2 = ("receiver@example.com").replace(";",",");
    String cc_tSendMail_2 = (("carbon@example.com")==null || "".equals("carbon@example.com"))?null:("carbon@example.com").replace(";",",");
    String bcc_tSendMail_2 = (("blindcarbon@example.com")==null || "".equals("blindcarbon@example.com"))?null:("blindcarbon@example.com").replace(";",",");
	...
	String message_tSendMail_2 = (("Hello") == null || "".equals("Hello")) ? "\"\"" : ("Hello") ;
	...
	final String decryptedPassword_tSendMail_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:mgSa1Y1C9p0/5g3SWhRF/8X8fpr08M3ILBQBeJZA1YqTQ+Sy768=");
				
				
				return new javax.mail.PasswordAuthentication("bilejohan04@gmail.com", decryptedPassword_tSendMail_2); 
				}         
			});   
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tDBInput_1 - inputs:(after_tFileInputRaw_1) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
			   		// linked node: tMap_1 - inputs:(row8,row3,row4,row7) outputs:(out1)
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5r5FLZn919zu/yePm2M6NooyWN/VjprrNtAhIUJn+H34yQy3Cg+NM+o=");
				
				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;
				
				String url_tDBInput_1 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "mspr2";
		    ...
		    String dbquery_tDBInput_1 = "SELECT trajet_id FROM trajet";
        	...
        	row3.trajet_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.gare == null) ? 0 : this.gare.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						} else if (!this.gare.equals(other.gare))
	...
	public void copyDataTo(row4Struct other) {
		...
		other.id = this.id;
	            other.gare = this.gare;
	            other.slug = this.slug;
	            other.uic = this.uic;
	            other.uic8 = this.uic8;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.uic = readString(dis,ois);
					
						this.uic8 = readInteger(dis,ois);
						...
						this.newColumn = readString(dis,ois);
					
						this.newColumn1 = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.id, dos, oos);
						...
						writeString(this.uic, dos, oos);
					
					writeInteger(this.uic8, dos, oos);
						...
						writeString(this.newColumn, dos, oos);
					
						writeString(this.newColumn1, dos, oos);
    ...
    public String toString() {
		...
		sb.append(",slug="+slug);
		sb.append(",uic="+uic);
		sb.append(",uic8="+String.valueOf(uic8));
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.gare, other.gare);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tFileInputDelimited_1 - inputs:(after_tFileInputRaw_1) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_1 - inputs:(row8,row3,row4,row7) outputs:(out1)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/Users/josep/Mspr2/MSPR/données/stations.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/josep/Mspr2/MSPR/données/stations.csv", "ISO-8859-15",";","\n",true,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "row4", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row4.gare = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row4.slug = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row4.uic = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row4.uic8 = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uic8", "row4", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row4.latitude = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"latitude", "row4", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row4.longitude = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"longitude", "row4", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 7;
							...
							row4.newColumn = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 8;
					
							row4.newColumn1 = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
if(row4 != null) { 
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.gare = row4.gare;
				
				row4_HashRow.slug = row4.slug;
				
				row4_HashRow.uic = row4.uic;
				
				row4_HashRow.uic8 = row4.uic8;
				
				row4_HashRow.latitude = row4.latitude;
				
				row4_HashRow.longitude = row4.longitude;
				
				row4_HashRow.newColumn = row4.newColumn;
				
				row4_HashRow.newColumn1 = row4.newColumn1;
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("C:/Users/josep/Mspr2/MSPR/données/stations.csv") instanceof java.io.InputStream)){
...
row7Struct row7 = new row7Struct();
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tExtractJSONFields_2 - inputs:(row6) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_1 - inputs:(row8,row3,row4,row7) outputs:(out1)
 ...
 */
	...
	currentComponent="tFileInputRaw_2";
		...
		int tos_count_tFileInputRaw_2 = 0;
				...
				try {					
					String content_tFileInputRaw_2 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File("C:/Users/josep/Mspr2/MSPR/données/nigth/trips.json"), "ISO-8859-15");
					row6.content = content_tFileInputRaw_2;					
					globalMap.put("tFileInputRaw_2_FILENAME_PATH", "C:/Users/josep/Mspr2/MSPR/données/nigth/trips.json");
 ...
 */
	...
	currentComponent="tExtractJSONFields_2";
            ...
            if(row6.content!=null){// C_01
                jsonStr_tExtractJSONFields_2 = row6.content.toString();
...
for(int i_tExtractJSONFields_2=0; isStructError_tExtractJSONFields_2 || (i_tExtractJSONFields_2 < resultset_tExtractJSONFields_2.size());i_tExtractJSONFields_2++){
	...
	try {
		jsonPath_tExtractJSONFields_2 = "$.trip_id";
		...
		try {
				...
				row7.trip_id = value_tExtractJSONFields_2 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_2 = "$.via";
		compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
		...
		try {
				...
				row7.via = value_tExtractJSONFields_2 == null ? 
...
if(row7 != null) { 
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.trip_id = row7.trip_id;
				
				row7_HashRow.via = row7.via;
 ...
 */
    ...
    public static void main(String[] args){
        final itineraire itineraireClass = new itineraire();

        int exitCode = itineraireClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = itineraire.class.getClassLoader().getResourceAsStream("mspr2/itineraire_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = itineraire.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : itineraire");
        }
...
/************************************************************************************************
 *     158531 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:23:27 CEST
 ************************************************************************************************/