...
/**
 * Job: operateur Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class operateur implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "operateur";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(operateur.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_MSPR2_operateur = new byte[0];
    static byte[] commonByteArray_MSPR2_operateur = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String code_operateur;

				public String getCode_operateur () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.code_operateur == null) ? 0 : this.code_operateur.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final out1Struct other = (out1Struct) obj;
						...
						if (this.code_operateur == null) {
							if (other.code_operateur != null)
								return false;
						
						} else if (!this.code_operateur.equals(other.code_operateur))
	...
	public void copyDataTo(out1Struct other) {
		...
		other.code_operateur = this.code_operateur;
	            other.nom_operateur = this.nom_operateur;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR2_operateur.length) {
				if(length < 1024 && commonByteArray_MSPR2_operateur.length == 0) {
   					commonByteArray_MSPR2_operateur = new byte[1024];
				} else {
   					commonByteArray_MSPR2_operateur = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR2_operateur, 0, length);
			strReturn = new String(commonByteArray_MSPR2_operateur, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR2_operateur) {

        	try {

        		int length = 0;
		
					this.code_operateur = readString(dis);
					
					this.nom_operateur = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.code_operateur,dos);
					
					// String
				
						writeString(this.nom_operateur,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("code_operateur="+code_operateur);
		sb.append(",nom_operateur="+nom_operateur);
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.code_operateur, other.code_operateur);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		synchronized(commonByteArrayLock_MSPR2_operateur) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.agency_name = readString(dis);
					
					this.agency_url = readString(dis);
					
					this.agency_state = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.agency_name,dos);
					
					// String
				
						writeString(this.agency_url,dos);
					
					// String
				
						writeString(this.agency_state,dos);
    ...
    public String toString() {
		...
		sb.append(",agency_name="+agency_name);
		sb.append(",agency_url="+agency_url);
		sb.append(",agency_state="+agency_state);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("operateur");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("operateur");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:4N2ghRsSTZxCMavKPvBLxKdeIhsdCmdO7Boou2RD3HDBToTbRKlDSI8=");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"code_operateur\",\"nom_operateur\",\"iso_pays\") VALUES (?,?,?)";
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
		...
		int tos_count_tFileInputRaw_1 = 0;
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File("C:/Users/josep/Mspr2/MSPR/données/nigth/agencies.json"   ), "UTF-8");
					row1.content = content_tFileInputRaw_1;					
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", "C:/Users/josep/Mspr2/MSPR/données/nigth/agencies.json"   );
...
for(int i_tExtractJSONFields_1=0; isStructError_tExtractJSONFields_1 || (i_tExtractJSONFields_1 < resultset_tExtractJSONFields_1.size());i_tExtractJSONFields_1++){
	...
	try {
		...
		try {
				...
				row2.agency_id = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.agency_name";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.agency_name = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.agency_url";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.agency_url = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.agency_state";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.agency_state = value_tExtractJSONFields_1 == null ? 
...
// # Output table : 'out1'
out1_tmp.code_operateur = row2.agency_id ;
out1_tmp.nom_operateur = row2.agency_name ;
out1_tmp.iso_pays = ("UK".equals(row2.agency_state) || "US".equals(row2.agency_state)) 
    ? "GB" 
    : row2.agency_state ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(out1.code_operateur == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, out1.code_operateur);
}

                    if(out1.nom_operateur == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, out1.nom_operateur);
}

                    if(out1.iso_pays == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, out1.iso_pays);
}
 ...
 */
    ...
    public static void main(String[] args){
        final operateur operateurClass = new operateur();

        int exitCode = operateurClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = operateur.class.getClassLoader().getResourceAsStream("mspr2/operateur_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = operateur.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : operateur");
        }
...
/************************************************************************************************
 *     59053 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:23:54 CEST
 ************************************************************************************************/