...
/**
 * Job: type_train Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class type_train implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "type_train";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(type_train.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_MSPR2_type_train = new byte[0];
    static byte[] commonByteArray_MSPR2_type_train = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR2_type_train.length) {
				if(length < 1024 && commonByteArray_MSPR2_type_train.length == 0) {
   					commonByteArray_MSPR2_type_train = new byte[1024];
				} else {
   					commonByteArray_MSPR2_type_train = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR2_type_train, 0, length);
			strReturn = new String(commonByteArray_MSPR2_type_train, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR2_type_train) {

        	try {

        		int length = 0;
		
					this.type_nom = readString(dis);
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		synchronized(commonByteArrayLock_MSPR2_type_train) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.trip_short_name = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.trip_short_name,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("trip_short_name="+trip_short_name);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("type_train");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("type_train");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9WUiAa7sWpJHaoPIgFi79IjAa44ROXui55bKJ9sDCZYoXZsGvdcVnv0=");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"type_nom\") VALUES (?)";
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
		...
		int tos_count_tFileInputRaw_1 = 0;
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File("C:/Users/josep/Mspr2/MSPR/données/nigth/trips.json"), "ISO-8859-15");
...
// # Output table : 'out1'
out1_tmp.type_nom = row2.trip_short_name ;
out1 = out1_tmp;
// ###############################
...
if(row3 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row3.type_nom == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row3.type_nom);
}
 ...
 */
    ...
    public static void main(String[] args){
        final type_train type_trainClass = new type_train();

        int exitCode = type_trainClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = type_train.class.getClassLoader().getResourceAsStream("mspr2/type_train_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = type_train.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : type_train");
        }
...
/************************************************************************************************
 *     59209 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:24:42 CEST
 ************************************************************************************************/