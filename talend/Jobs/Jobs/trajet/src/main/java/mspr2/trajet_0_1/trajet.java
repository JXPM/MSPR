...
/**
 * Job: trajet Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class trajet implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "trajet";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(trajet.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_MSPR2_trajet = new byte[0];
    static byte[] commonByteArray_MSPR2_trajet = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR2_trajet.length) {
				if(length < 1024 && commonByteArray_MSPR2_trajet.length == 0) {
   					commonByteArray_MSPR2_trajet = new byte[1024];
				} else {
   					commonByteArray_MSPR2_trajet = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR2_trajet, 0, length);
			strReturn = new String(commonByteArray_MSPR2_trajet, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR2_trajet) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.gare_depart = readString(dis);
					
					this.gare_arrivee = readString(dis);
					
					this.heure_depart = readString(dis);
					
					this.heure_arrivee = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.gare_depart,dos);
					
					// String
				
						writeString(this.gare_arrivee,dos);
					
					// String
				
						writeString(this.heure_depart,dos);
					
					// String
				
						writeString(this.heure_arrivee,dos);
    ...
    public String toString() {
		...
		sb.append(",gare_depart="+gare_depart);
		sb.append(",gare_arrivee="+gare_arrivee);
		sb.append(",heure_depart="+heure_depart);
		sb.append(",heure_arrivee="+heure_arrivee);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("trajet");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("trajet");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ct9t0bTr4o+T1oecy/Xf2jEBgcl7jOO3YDcVrXjR47JADN5FXuThGE8=");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"trajet_id\",\"gare_depart\",\"gare_arrivee\",\"heure_depart\",\"heure_arrivee\",\"id_ligne\") VALUES (?,?,?,?,?,?)";
...
;
		...
		try {
				...
				row2.trip_origin = value_tExtractJSONFields_1 == null ? 
...
;
		...
		try {
				...
				row2.trip_headsign = value_tExtractJSONFields_1 == null ? 
...
;
		...
		try {
				...
				row2.origin_departure_time = value_tExtractJSONFields_1 == null ? 

		null

 : value_tExtractJSONFields_1.toString();
		} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_1) {
			row2.origin_departure_time = 
...
;
		...
		try {
				...
				row2.destination_arrival_time = value_tExtractJSONFields_1 == null ? 
...
;
		...
		try {
				...
				if(value_tExtractJSONFields_1 != null && !value_tExtractJSONFields_1.toString().isEmpty()) {
					row2.route_id = ParserUtils.parseTo_Integer(value_tExtractJSONFields_1.toString());
				} else {
					row2.route_id = 
...
out1_tmp.gare_depart = row2.trip_origin ;
out1_tmp.gare_arrivee = row2.trip_headsign ;
out1_tmp.heure_depart = row2.origin_departure_time ;
out1_tmp.heure_arrivee = row2.destination_arrival_time ;
out1_tmp.id_ligne = row2.route_id ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(out1.trajet_id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, out1.trajet_id);
}

                    if(out1.gare_depart == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, out1.gare_depart);
}

                    if(out1.gare_arrivee == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, out1.gare_arrivee);
}

                    if(out1.heure_depart == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, out1.heure_depart);
}

                    if(out1.heure_arrivee == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, out1.heure_arrivee);
}

                    if(out1.id_ligne == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(6, out1.id_ligne);
}
 ...
 */
    ...
    public static void main(String[] args){
        final trajet trajetClass = new trajet();

        int exitCode = trajetClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = trajet.class.getClassLoader().getResourceAsStream("mspr2/trajet_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = trajet.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : trajet");
        }
...
/************************************************************************************************
 *     61892 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:24:26 CEST
 ************************************************************************************************/